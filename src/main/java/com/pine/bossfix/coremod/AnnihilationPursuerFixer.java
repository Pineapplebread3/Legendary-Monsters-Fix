...
public class AnnihilationPursuerFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found AnnihilationPursuerEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying AnnihilationPursuerEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] AnnihilationPursuerEntity.addEffect modified!");
    }
}