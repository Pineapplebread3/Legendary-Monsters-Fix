...
public class FrostbittenGolemFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found Frostbitten_GolemEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying Frostbitten_GolemEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] Frostbitten_GolemEntity.addEffect modified!");
    }
}