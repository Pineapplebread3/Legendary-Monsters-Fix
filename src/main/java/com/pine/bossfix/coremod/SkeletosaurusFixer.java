...
public class SkeletosaurusFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found SkeletosaurusEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying SkeletosaurusEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] SkeletosaurusEntity.addEffect modified!");
    }
}