...
public class TheWarpedOneFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found TheWarpedOneOld!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying TheWarpedOneOld.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] TheWarpedOneOld.addEffect modified!");
    }
}