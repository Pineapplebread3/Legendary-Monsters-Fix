...
public class LavaEaterFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found Lava_eaterEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying Lava_eaterEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] Lava_eaterEntity.addEffect modified!");
    }
}