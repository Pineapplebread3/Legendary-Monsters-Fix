...
public class EndersentFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found EndersentEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying EndersentEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] EndersentEntity.addEffect modified!");
    }
}