...
public class TheObliteratorFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        ...
        System.out.println("[BossFix] Found TheObliteratorEntity!");

        // 1. 修复 addEffect 方法（如果有）
        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying TheObliteratorEntity.addEffect...");
        ...
        for (MethodNode method : classNode.methods) {
            if (method.name.equals("damageCap") && method.desc.equals("()D")) {
                System.out.println("[BossFix] Removing damage cap in TheObliteratorEntity...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] TheObliteratorEntity.addEffect modified!");
    }
}