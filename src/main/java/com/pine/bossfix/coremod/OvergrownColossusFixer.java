...
public class OvergrownColossusFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found Overgrown_colossusEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying Overgrown_colossusEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] Overgrown_colossusEntity.addEffect modified!");
    }
}