...
public class WitheredAbominationFixer {
    ...
    public static boolean fix(ClassNode classNode) {
        System.out.println("[BossFix] Found Withered_AbominationEntity!");

        for (MethodNode method : classNode.methods) {
            if (isAddEffectMethod(method)) {
                System.out.println("[BossFix] Modifying Withered_AbominationEntity.addEffect...");
    ...
    private static void modifyAddEffectMethod(MethodNode method) {
        ...
        System.out.println("[BossFix] Withered_AbominationEntity.addEffect modified!");
    }
}